...
import { Box, Text, OrbitControls, PerspectiveCamera } from "@react-three/drei"
...
// Simple function to request a WebXR session
function enterVR() {
  if (typeof navigator !== "undefined" && "xr" in navigator) {
    // @ts-ignore - TypeScript doesn't know about navigator.xr
    navigator.xr
  ...
  return (
    <>
      ...
      <Text position={[0, 1.7, -3]} fontSize={0.1} color="white" anchorX="center" anchorY="middle">
        Use arrow keys to rotate selected faces
      </Text>
